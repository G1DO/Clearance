...
- Controller starts against an empty database via Flyway V1-V3 (V3 adds runners/attempts/allocations; see controller/src/main/resources/db/migration/V3__scheduling.sql) and restart revalidates without drift
...
- See docs/design/specifications/job-intake.md, docs/design/specifications/runner-ownership-semantics.md, docs/design/specifications/runner-claim.md, and contracts/agent-v1/README.md for what the checks prove and their bounds
